function [rmse] = ZF_2sos(paras,mapB1,spatial,targetVec,maxiter,mapB0)
%function to create two single spiral according the parameters from Eq. 1 in the manuscript.
%both spirals have specific positions on the z-axis of the k-space (paras(9) and paras(10)).
